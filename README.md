...
このポリシー（以下「本ポリシー」といいます。）は、株式会社キカガク（以下「当社」といいます。）が提供するテスト受験サービス「キカガク for Business DX人材アセスメント」及び「キカガク for Business スキル可視化」（以下「本サービス」といいます。）におけるテスト受験の規則等を定めるものであり、本サービスを利用するすべてのお客様に適用されます。お客様は、本サービスを利用する前に、本ポリシーをよくお読みください。本ポリシーに同意されないユーザーは、本サービスを利用することはできません。
